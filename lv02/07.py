...
def solution(topping):
    answer = 0
    if len(topping)%2 == 0 or len(set(topping)) == 1:    
...
"""
이문제의 핵심은 "두 쪽의 토핑 종류 수를 실시간으로 관리하고 비교"하는 것.

set은 추가만, dict는 제거 감지용.

이걸 통해 전체 시간 복잡도를 O(n) 으로 유지 가능.
"""
...
print(solution3([1, 2, 1, 3, 1, 4, 1, 2]))
print(solution3([1, 2, 3, 1, 4]))
